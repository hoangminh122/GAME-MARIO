...
#define MARIO_ANI_BIG_WALKING_HOLD_TURTLE_RIGHT		81
#define MARIO_ANI_BIG_WALKING_HOLD_TURTLE_LEFT		82
#define MARIO_ANI_BIG_RUN_HOLD_TURTLE_RIGHT		83
#define MARIO_ANI_BIG_RUN_HOLD_TURTLE_LEFT		84
